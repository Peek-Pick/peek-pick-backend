...
public interface ProductLikeRepository extends JpaRepository<ProductLikeEntity, Long> {
    Optional<ProductLikeEntity> findByProductEntity_ProductIdAndUserEntity_UserId(Long productId, Long userId);
    ...
    """)
    boolean hasUserLikedProduct(@Param("productId") Long productId,
    ...
    @Query("""
        ...
        WHERE pl.productEntity.productId = :productId
          AND pl.userEntity.userId = :userId
    """)
    int activateLike(@Param("productId") Long productId,
                     @Param("userId") Long userId);
    ...
    @Query("""
        ...
        WHERE pl.productEntity.productId = :productId
          AND pl.userEntity.userId = :userId
    """)
    int deactivateLike(@Param("productId") Long productId,
                       @Param("userId") Long userId);
