...
public interface AdminPointRepository extends JpaRepository<PointStoreEntity, Long>, AdminPointRepositoryCustom {
    ...
    //목록
    @Query("select new org.beep.sbpp.admin.points.dto.PointStoreListDTO(p.pointstoreId, p.item, p.price, p.productType, p.imgUrl) " +
